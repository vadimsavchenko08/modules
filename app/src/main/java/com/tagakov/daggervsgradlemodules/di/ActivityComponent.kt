...
@MainActivityScope
@Component(
        modules = [BindingsModule::class, AModule::class, Module::class, ComponentDependenciesModule::class],
        dependencies = [TimelogicComponent::class]
)
internal interface MainComponent : StartScreenDependencies, UserScreenDependencies, AProvider {
...
private abstract class ComponentDependenciesModule private constructor() {
    @Binds
    @IntoMap
    @ComponentDependenciesKey(StartScreenDependencies::class)
    abstract fun provideStartScreenDependencies(component: MainComponent): ComponentDependencies

    @Binds
    @IntoMap
    @ComponentDependenciesKey(UserScreenDependencies::class)
    abstract fun provideUserScreenDependencies(component: MainComponent): ComponentDependencies

    @Binds
    @IntoMap
    @ComponentDependenciesKey(AProvider::class)
    abstract fun provideA(component: MainComponent): ComponentDependencies
}
